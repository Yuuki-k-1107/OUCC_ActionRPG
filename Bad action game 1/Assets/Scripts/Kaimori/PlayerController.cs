...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Input.GetKeyDown(KeyCode.UpArrow) || (Input.GetKeyDown(KeyCode.W))) && isground.ground/*(Input.GetKeyDown(KeyCode.LeftShift) || Input.GetKeyDown(KeyCode.RightShift)) && isground.ground == true*/)
        {
